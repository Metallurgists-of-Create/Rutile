...
import dev.metallurgists.rutile.api.fluid.attribute.IAttributedFluid;
...
public abstract class MaterialFluid extends BaseFlowingFluid implements IAttributedFluid {
    ...
    public MaterialFluid(@NotNull FluidState state, int burnTime, BaseFlowingFluid.Properties properties) {
        super(properties);
        this.state = state;
