...
public class MaterialRegistryManager implements IMaterialRegistryManager {
    ...
    private final MaterialRegistryImpl rutileRegistry = createInternalRegistry();
    ...
    public MaterialRegistry getRegistry(@NotNull String modid) {
        ...
        return registry != null ? registry : rutileRegistry;
    }
    ...
    private MaterialRegistryImpl createInternalRegistry() {
        MaterialRegistryImpl registry = new MaterialRegistryImpl(Rutile.ID);
        this.registries.put(Rutile.ID, registry);
        return registry;
    }

    @NotNull
    public Material getDefaultFallback() {
        return rutileRegistry.getFallbackMaterial();
    }
}
