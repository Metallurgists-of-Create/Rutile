...
public class ModelHelpers {
    ...
    public static void generatedItemModel(Material material, TagPrefix tagPrefix) {
        ResourceManager resourceManager = Minecraft.getInstance().getResourceManager();
        String namespace = material.getModId();
        String flagName = (defaultFlagSources.contains(tagPrefix.getModId()) ? "" : tagPrefix.getModId() + "_") + tagPrefix.getName();
        ...
        String texture = texturePresent ? material.getModId() + ":item/materials/" + material.getName() + "/" + flagName : "rutile:item/materials/null/" + flagName;
        RutileDynamicResourcePack.addItemModel(ResourceLocation.fromNamespaceAndPath(material.getModId(), tagPrefix.idPattern().formatted(material.getName())), ModelHelpers.simpleGeneratedModel("minecraft:item/generated", texture));
    }

    public static void cubeAllBlockModel(Material material, TagPrefix tagPrefix) {
        ResourceManager resourceManager = Minecraft.getInstance().getResourceManager();
        String namespace = material.getModId();
        String flagName = (defaultFlagSources.contains(tagPrefix.getModId()) ? "" : tagPrefix.getModId() + "_") + tagPrefix.getName();
        ...
        String texture = texturePresent ? material.getModId() + ":block/materials/" + material.getName() + "/" + flagName : "metallurgica:block/materials/null/" + flagName;
        RutileDynamicResourcePack.addBlockModel(ResourceLocation.fromNamespaceAndPath(namespace, tagPrefix.idPattern().formatted(material.getName())), ModelHelpers.simpleCubeAll(texture));
        RutileDynamicResourcePack.addBlockState(ResourceLocation.fromNamespaceAndPath(namespace, tagPrefix.idPattern().formatted(material.getName())), ModelHelpers.singleVariantBlockstate(material.getModId() + ":block/" + tagPrefix.idPattern().formatted(material.getName())));
        RutileDynamicResourcePack.addItemModel(ResourceLocation.fromNamespaceAndPath(namespace, tagPrefix.idPattern().formatted(material.getName())), ModelHelpers.simpleParentedModel(material.getModId() + ":block/" + tagPrefix.idPattern().formatted(material.getName())));
    }
}
