...
public abstract class MappedRegistryMixin<T> extends BaseMappedRegistry<T>
    ...
    @Override
    public boolean rutile$isFrozen() {
        return this.frozen;
    }

    @Override
    public ObjectList<Holder.Reference<T>> rutile$getById() {
        return this.byId;
    }

    @Override
    public Reference2IntMap<T> rutile$getToId() {
        return this.toId;
    }

    @Override
    public Map<ResourceLocation, Holder.Reference<T>> rutile$getByLocation() {
        return this.byLocation;
    }

    @Override
    public Map<ResourceKey<T>, Holder.Reference<T>> rutile$getByKey() {
        return this.byKey;
    }

    @Override
    public Map<T, Holder.Reference<T>> rutile$getByValue() {
        return this.byValue;
    }

    @Override
    public Map<ResourceKey<T>, RegistrationInfo> rutile$getRegistrationInfos() {
