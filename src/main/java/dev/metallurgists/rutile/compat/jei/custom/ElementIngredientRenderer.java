...
public class ElementIngredientRenderer implements IIngredientRenderer<ElementStack> {
    ...
    public void render(GuiGraphics guiGraphics, ElementStack element, int posX, int posY) {
        if (element != null) {
            ...
            if (element.getAmount() != 1) {
                String s = String.valueOf(element.getAmount());
                guiGraphics.pose().translate(0.0F, 0.0F, 200.0F);
                guiGraphics.drawString(font, s, posX + 19 - 2 - font.width(s), posY + 6 + 3, 16777215, true);
            }
    ...
    public Optional<TextureAtlasSprite> getStillFluidSprite() {
        return Optional.ofNullable(Minecraft.getInstance()
                        ...
                        .apply(Rutile.getResource("fluid/liquid")))
